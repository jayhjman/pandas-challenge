...
1. Charter schools have higher math, reading and overall passing grades which is consistent with looking at the scores by school size (point raised in #1 pperviously)
1. Per student budget does appear to be an indicator of passing scores as lower per student spending has higher passing rates than those schools who spend more on a student (however might br higher costs because of the sheer number of students, staff, teachers, facilites needed)
